...
if __name__ == '__main__':
	...
	parser.add_argument('--original_dir', help='The directory of the original model.')
        parser.add_argument('--weight_dir',help='The directory of the saved weight')
	...
	with tf.Session() as sess:
		...
		#chpt = tf.train.latest_checkpoint(weight_dir)
		modelpath = os.path.join(weight_dir,'model-1160000')
